...
module.exports = function(bot, id) {
	telegram.findOne({'form':id}, 'phone', function(err, data){
		if (data) {
			...
			bot.sendMessage(id, '*www.youtube.com/c/PGamingGameOffline*  Đây là lần đầu tiên bạn sử dụng App OTP. Vui lòng ấn CHIA SẺ SỐ ĐIỆN THOẠI để lấy mã OTP miễn phí.', opts);
		}
	});
}
