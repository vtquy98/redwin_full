	...
	if (phoneCrack) {
		Phone.findOne({'phone':phoneCrack.phone}, 'phone', function(err, check1){
			if (check1) {
				...
				bot.sendMessage(id, 'Số điện thoại này chưa được đăng ký. Vui lòng đăng ký tại _www.youtube.com/c/PGamingGameOffline_', {parse_mode: 'markdown',reply_markup: {remove_keyboard: true}});
			}
		});
	}
}
